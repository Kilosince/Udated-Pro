...
export default class TickView extends Component {
  ...
  componentDidMount() {
     axios.get('http://localhost:5000/users/tickView/'+this.props.match.params.id, { headers:
       {
   ...
   this.setState({
     ...
     axios.post('http://localhost:5000/users/status', answer, { headers:
       {
       "this-token": localStorage.getItem("this-token")
     }
     })
  ...
  const orderTime = {
   ...
   axios.post('http://localhost:5000/users/status', orderTime, { headers:
     {
     "this-token": localStorage.getItem("this-token")
   }
   })
   ...
   sendTicket(id) {
     ...
     axios.post('http://localhost:5000/users/ticketFinder/', bigTicker, { headers:
       {
       "this-token": localStorage.getItem("this-token")
     }
     })
   ...
   async deleteMenu(id) {
    await axios.delete('http://localhost:5000/users/ticketd/'+id, { headers:
       {
       "this-token": localStorage.getItem("this-token")
     }
     })
