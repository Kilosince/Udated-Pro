...
export default class MenuItems extends Component {
  constructor(props) {
   ...
   componentDidMount() {
      axios.get('http://localhost:5000/users/amino', { headers:
        {
      ...
      //Send ticket as part of delete process
        ...
        await axios.post('http://localhost:5000/users/ticketFinder/', ticket, { headers:
          {
          "this-token": localStorage.getItem("this-token")
        }
        })
      ...
      deleteMenu(id, our) {
          console.log(id);
         axios.delete('http://localhost:5000/users/damino/'+id, { headers:
            {
            "this-token": localStorage.getItem("this-token")
          }
          })
